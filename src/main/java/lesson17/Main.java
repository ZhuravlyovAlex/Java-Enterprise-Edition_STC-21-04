...
public class Main {
    public static void main(String[] args) {
        ...
        Bird bird = new Bird(7,"Кеша",yana,0);
        Fish fish = new Fish (8, "Клоун",igor,0);
        ...
        petCardList.addPet(bird);
        petCardList.addPet(fish);
        ...
        System.out.println("изменение данных животного по его идентификатору " +
                "(у питомца по кличке Граф изменим вес с 8.0 на 8.7");
        ...
        System.out.println();
        System.out.println("изменение клички животного по его идентификатору " +
                "(у питомца по кличке Граф изменим вес Граф на Шариков");
        petCardList.petUpdate(6, "Шариков");
        petCardList.sortView();
        System.out.println();
        System.out.println("изменение данных о владельце животного по его идентификатору " +
                "(питомц по кличке Шариков переехал от Влады к Яне");
        petCardList.petUpdate(6,yana);
        petCardList.sortView();
        System.out.println();
        petCardList.search("Шариков");
        System.out.println();
        // Вывод иноформации о способностях питомцев по их имени.
        petCardList.showAbility("Кеша");
        petCardList.showAbility("Шариков");
        petCardList.showAbility("Васька");
    }
}
